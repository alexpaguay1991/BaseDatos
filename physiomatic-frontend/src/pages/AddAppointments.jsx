...
function AddAppointments() {
  ...
  }, [doctor_id, date]); // Dependencias del useEffect
  ...
  const fetchAvailableAppointments = async () => {
    const appointments = await availableAppointments(doctor_id, date);
    ...
    <Card className="w-full">
      ...
      <div className="w-5/12">
        ...
        <div className="mb-2 block">
          <Label for="patient" value="Buscar Paciente" />
        </div>
        <TextInput
          id="patient"
          type="text"
        ...
        <Card className="w-full">
          ...
          <div className="flex  items-start gap-8">
            <div className="w-5/12">
              <div className="flex justify-between">
                <div className="mb-2 block">
                  <Label for="national_id" value="Cédula" />
                </div>
              </div>
              <TextInput
                id="national_id"
      ...
      {patient.id && (
        <Card className="w-full">
          ...
          >
            ...
            <div className="w-5/12">
              <div className="mb-2 block">
                <Label for="date" value="Fecha de la cita" />
              </div>
              <Datepicker
                id="date"
                weekStart={1}
            ...
            <div className="w-5/12">
              <div className="mb-2 block">
                <Label for="time" value="Hora de la cita" />
              </div>
              <Select
                id="time"
                name="time"
